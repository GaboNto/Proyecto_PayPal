...
let UsersService = class UsersService {
    ...
    async updateProfile(userId, updateProfileDto) {
        ...
        if (updateProfileDto.apellido !== undefined) {
            user.apellido = updateProfileDto.apellido;
        }
        if (updateProfileDto.fecha_nacimiento !== undefined) {
            user.fecha_nacimiento = updateProfileDto.fecha_nacimiento;
        }
        ...
        if (updateProfileDto.facturacion !== undefined) {
            user.facturacion = updateProfileDto.facturacion;
        }
        return this.usersRepository.save(user);
    }
};
