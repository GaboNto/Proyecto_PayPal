...
const reset_token_entity_1 = require("./auth/entities/reset-token.entity");
        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: async (configService) => ({
                    ...
                    entities: [user_entity_1.User, movimiento_entity_1.Movimiento, card_entity_1.Card, cuenta_entity_1.Cuenta, transferencia_entity_1.Transferencia, usuario_externo_entity_1.UsuarioExterno, destinatario_entity_1.Destinatario, pago_entity_1.Pago, historial_saldos_1.HistorialSaldos, reset_token_entity_1.ResetToken],
                    synchronize: true,
                }),
