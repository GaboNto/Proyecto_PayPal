...
let AuthController = class AuthController {
    ...
    async resetPassword(resetPasswordDto) {
        const success = await this.emailService.resetPassword(resetPasswordDto.token, resetPasswordDto.newPassword);
        if (success) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Restablece la contraseña usando un token válido' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Verifica el email del usuario usando un token' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Email verificado exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Token inválido o expirado' }),
