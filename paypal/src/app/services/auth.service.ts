...
export class AuthService {
  ...
  activate2FA(code: string): Observable<{ success: boolean; message: string }> {
    return this.http.post<{ success: boolean; message: string }>(`${this.baseUrl}/users/2fa/activate`, { code });
  }
